...
ItemDrop.item_drop = {
		{items = {"item_recipe_weapon_stick_2;item_armor;item_helmet"}, chance = 50, units = {"npc_boss_1"}},
		{items = {"item_ent_root"}, chance = 50, units = {"npc_creep_2"}},
		{items = {"item_recipe_weapon_f1-1;item_recipe_armor_f1-1;item_recipe_helmet_f1-1;"}, chance = 50, units = {"npc_boss_2"}},
		{items = {"item_wendigo_claw"}, chance = 50, units = {"npc_creep_3"}},
		{items = {"item_recipe_weapon_f1-2;item_recipe_armor_f1-2;item_recipe_helmet_f1-2;"}, chance = 50, units = {"npc_boss_3"}},
}
