...
function PortalArea( keys )
	...
	elseif trigger_name == "portal_3" then
		point_name = "point_portal_3"
	elseif trigger_name == "portal_4" then
		point_name = "point_portal_4"
	elseif trigger_name == "portal_5" then
		point_name = "point_portal_5"
	elseif trigger_name == "portal_6" then
		point_name = "point_portal_6"
	elseif trigger_name == "portal_7" then
		point_name = "point_portal_7"
	elseif trigger_name == "portal_8" then
		point_name = "point_portal_8"
	end
